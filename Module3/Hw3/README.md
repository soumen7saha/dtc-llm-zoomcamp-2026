...
`AI Copilot has built-in access to current Kestra plugin documentation`
...
`Output Token Count for short summary: 60`
...
`Output Token for 3 sentences: 85`

`Output Token for 1 sentence: 38`
...
`Traditional Workflows are used for Deterministic, predictable, compliant cases`
